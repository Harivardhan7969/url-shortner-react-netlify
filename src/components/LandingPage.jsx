      ...
      <div className="lg:flex-row flex-col    lg:py-5   pt-16   lg:gap-10 gap-8 flex justify-between items-center">
        <div className=" flex-1">
          ...
          <p className="text-slate-700 text-sm my-5">
            Wisestep streamlines the process of URL shortening,
            making link sharing effortless and efficient.
            With its intuitive and user-friendly interface,
            Wisestep allows you to generate concise,
            easy-to-share URLs in seconds.
            Simplify your sharing experience and track performance with
            powerful insights—only with Wisestep’s smart link management.
          </p>
